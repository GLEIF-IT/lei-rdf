...
ls -1 ontology/ | grep ttl | cut -d '.' -f 1 | while read ontology ; do sed -E -i ".bak" "s/Ontology Specification Draft/Ontology Specification/g" target/$ontology/index-en.html ; done
