...
# e.g. 2019/10/31/254220/20191031-1600-gleif-goldencopy-rr-golden-copy
...
echo applying GLEIF-L2.xsl to $local.xml
java -cp ~/saxon/saxon9ee.jar net.sf.saxon.Transform -s:$local.xml -xsl:GLEIF-L2.xsl -o:$local.rdf
...
mv $local.rdf L2Data.rdf
zip L2Data.rdf.zip L2Data.rdf
...
curl -H "Authorization: Bearer $token" \
  ...
  https://api.data.world/v0/uploads/rivettp/gleif-2019-10-31/files/L2Data.rdf.zip
